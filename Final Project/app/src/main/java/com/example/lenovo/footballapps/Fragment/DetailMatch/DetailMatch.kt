...
import com.example.lenovo.footballapps.R.drawable.ic_add_to_favorites
import com.example.lenovo.footballapps.R.drawable.ic_added_to_favorites
import com.example.lenovo.footballapps.R.id.add_to_favorite
import com.example.lenovo.footballapps.R.menu.detail_menu
...
class DetailMatch : AppCompatActivity(), DetailMatchView {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        detailMatchPresenter = DetailMatchPresenter(this@DetailMatch, ApiRepository(), Gson())
